...
#ifndef __RENDER_TO_TEXTURE_FILTER_INVERT_H_
#define __RENDER_TO_TEXTURE_FILTER_INVERT_H_
...
#define FRAGMENT_SHADER_QUAD_NAME        SOURCES_PATH SHADERS_PATH "texture2d_filter_invert.frag"
#define BINARY_PROGRAM_SHADER_QUAD_NAME  SOURCES_PATH SHADERS_PATH "texture2d_filter_invert.bin"

static const char* diffuse_textures [] = { "../assets/textures/tsi_256x256.tga", "../assets/textures/vulkan_512x512.tga"};
static const char* shading_titles   [] = { "COLOR_INVERT" };

#endif // __RENDER_TO_TEXTURE_FILTER_INVERT_H_
